...
//cant get export/import to work 
    ...
    render() {
        ...
        <div className="row">
          <div className="col-md-1"></div>
            <div className="col-md-8 shoeboxdiv">
    ...
    render() {
        ...
        <div>
          ...
          <div className="container">
              <img src="http://res.cloudinary.com/osidekweenyasss/image/upload/v1519684600/whitenike.png" className="nikeShoe img1"/>
...
/*would add component will recieve props here, but seems to be updating fine without it*/
//would also like to make these boxes more responsive
...
class Parts extends React.Component {
  ...
  render() {
    var self = this;
    return (
    <div className="shoepart-div">
        {self.props.shoeParts.map(function(item){
        return(
          <div className="col-md-1 colorCircle whiteCircle bottomCircle" id={item} onClick={self.props.changeShoePart}>
